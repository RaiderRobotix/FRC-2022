...
/**
 * VisionPipeline implementation for retroflective tape. Tuned and generated
 * using GRIP
 *
...
public class GripPipeline implements VisionPipeline {
  ...
  private void filterContours(
      ...
      double minArea, double minPerimeter, 
      double minWidth, double maxWidth,
      double minHeight, double maxHeight, 
      double[] solidity, 
      double minVertexCount, double maxVertexCount,
